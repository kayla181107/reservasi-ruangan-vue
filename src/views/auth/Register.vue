<template>
  <div class="flex items-center justify-center min-h-screen relative overflow-hidden px-8 py-16">
    ...
    <!-- Card Register -->
    <div
      class="relative w-full max-w-2xl bg-white/95 backdrop-blur-xl p-8 md:p-12 rounded-2xl shadow-2xl border border-white/40 animate-fadeIn z-10"
    >
      <!-- Icon -->
      ...
      <p class="text-2xl md:text-3xl font-semibold text-center text-yellow-400 mb-4">
        Register
      </p>
      <p class="text-center text-sm md:text-base text-blue-900 mb-8">
      ...
      <form @submit.prevent="onRegister" class="space-y-5">
        ...
        <div class="group">
          ...
          <input
            ...
            class="w-full border border-white/40 bg-white/70 text-blue-900 rounded-xl px-4 py-3 md:px-5 md:py-4 focus:ring-2 focus:ring-blue-400 focus:border-yellow-400 focus:outline-none placeholder-blue-300 transition"
            required
          />
        </div>
        ...
        <button
          type="submit"
          :disabled="loading"
          class="w-full bg-gradient-to-r from-blue-500 via-purple-400 to-yellow-400 text-white py-3 md:py-4 rounded-xl font-semibold shadow-lg hover:opacity-90 hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 glow-button"
        >
      ...
      <!-- Login Link -->
      <p class="text-sm md:text-base text-center mt-8 text-blue-800">
        Sudah punya akun?
        <router-link
          to="/login"
